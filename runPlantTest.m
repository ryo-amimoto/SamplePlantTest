...
xlswrite("TestGraphOutput.xlsm",InputVal,"InputIF_In",'A2:J412');      % モデルの入力データを”テストファイル＿マクロ機能付き”へ出力
xlswrite("TestGraphOutput.xlsm",OutputVal,"InputIF_Out",'A2:I412');    % モデルの出力データを”テストファイル＿マクロ機能付き”へ出力
